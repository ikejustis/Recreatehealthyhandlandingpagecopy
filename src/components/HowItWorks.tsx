      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {steps.map((step, index) => (
            ...
            >
              {/* Card */}
              <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-md hover:shadow-lg transition-all border border-gray-200 h-full">
                {/* Step Number Badge */}
                <div className="absolute -top-3 -right-3 w-10 h-10 bg-[#72C975] text-white rounded-full flex items-center justify-center shadow-md" style={{ fontWeight: 600 }}>
        ...
        <div className="text-center mt-10 sm:mt-14">
          <button 
            ...
            className="px-8 sm:px-10 py-3 bg-[#1F5721] text-white rounded-full border-2 border-[#1F5721] hover:bg-white hover:text-[#1F5721] transition-all" 
