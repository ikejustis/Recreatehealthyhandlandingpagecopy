      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-5 sm:p-6 rounded-2xl bg-white border border-gray-200 hover:shadow-lg transition-all cursor-pointer"
            >
              {/* Icon */}
              <div className="bg-[#F0F9ED] w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mb-4 sm:mb-5 group-hover:bg-[#72C975]/10 transition-colors">
